...
public class TacticalRecommendation {
    ...
    private CEPRecommendation cepRecommendation;
    ...
    public TacticalRecommendation(BasicTacticalSettings basicSettings, KeyTeamInstructions teamInstructions,
            ...
            CEPRecommendation cepRecommendation) {
        ...
        this.cepRecommendation = cepRecommendation;
    }
    ...
    public CEPRecommendation getCepRecommendation() {
        return cepRecommendation;
    }

    public void setCepRecommendation(CEPRecommendation cepRecommendation) {
        this.cepRecommendation = cepRecommendation;
    }
